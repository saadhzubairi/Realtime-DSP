"""Voice profile module for extraction, serialization, and loading."""
...
from .pitch import PitchTracker, hz_to_log_f0
from .lpc import compute_lpc, lpc_to_spectrum
from .formant import FormantTracker
...
def extract_profile(
    ...
    skip_factor = max(1, num_frames // 150)
    ...
    for i in range(0, num_frames, skip_factor):
        ...
        formant_tracker.process_frame(frame)
    ...
    if pitch_stats['f0_median'] > 0 and pitch_stats['f0_p05'] > 0:
        f0_values_log = [
            hz_to_log_f0(pitch_stats['f0_p05']),
